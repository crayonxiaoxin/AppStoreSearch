...
<template>
  <main v-loading="loading" class="relative">
    ...
    <a class="absolute top-0 right-0 inline-block" href="https://github.com/crayonxiaoxin/AppStoreSearch" target="_blank">
    ...
    <div class="grid grid-cols-1 gap-6 md:gap-8 lg:gap-10 md:grid-cols-2 lg:grid-cols-2">
      <div v-for="item in list" :key="item.bundleId" class="flex gap-3">
        ...
        <div class="flex-2">
          ...
          <div class="text-green-800">{{ item.formattedPrice }}</div>
